public class RPG {
    public static void main(String[] args) {
        ...
        SwordsMan moster = new SwordsMan("黑暗劍士", 100, 25);

        Magician mage = new Magician("光明法師", 80, 15, 10);
        Magician enmage = new Magician("黑暗法師", 80, 20, 5);

        ShieldSwordsMan shieldSwordsMan = new ShieldSwordsMan("持盾劍士", 120, 18, 8);

        Role[] gameRoles = {hero, moster ,  mage , enmage, shieldSwordsMan};
